package JVT.JVT31_TheFileClass;
...
public class Lesson31 extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        randomFile2 = new File("C:\\TempDir\\random2.txt");
        ...
        if (randomFile.exists()) {
            ...
            randomFile2.renameTo(new File("C:\\TempDir\\random3.txt"));
